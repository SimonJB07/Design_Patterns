...
class TestSetUp(unittest.TestCase):
    ...
    def test_check_string(self):
        ...
        """
        print('Test 2')
        result = self.clear_up_data('String')
    ...
    def test_check_relationship(self):
        ...
        """
        print('Test 1')
        result = self.clean_up_relationship('DiagramModelo--TestModel')
    ...
    def test_reverse_word(self):
        ...
        """
        print('Test 3')
        result = self.reverse_words('DiagramModel Good')
    ...
    def test_set_up_attribute_name(self):
        ...
        """
        print('Test 4')
        result = self.set_up_attribute_name('int count_students:')
    ...
    def test_set_up_method_name(self):
        ...
        """
        print('Test 5')
        result = self.set_up_method_name('void get_name( String name )')
    ...
    def test_set_up_method_name_two(self):
        ...
        """
        print('Test 6')
        result = self.set_up_method_name('void set_number_student()')
    ...
    def test_set_up_class_name(self):
        ...
        """
        print('Test 7')
        result = self.set_up_class_name('classDiagramModel{')
